...
public class MarshmallowMonster
{
	...
	{
		String monster = "This Monster has " + monsterEyes + "eyes, " + monsterNoses + "noses, " + monsterHair + "hair, " + monsterLegs + "legs, " + monsterBellyButton + "bellybutton, and it's name is " + monsterName;
